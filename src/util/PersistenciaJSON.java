...
public class PersistenciaJSON {
    ...
    public static class DatosGuardados {
        ...
        public DatosGuardados(List<Ticket> tickets) {
    ...
    public static void guardar(Collection<Ticket> tickets) {
        try (PrintWriter pw = new PrintWriter(new FileWriter(ARCHIVO))) {
            ...
            System.out.println(
                    "Advertencia: no se pudieron guardar los datos ("
                    + e.getMessage() + ")"
            );
        }
    }
    ...
    public static DatosGuardados cargar() {
        ...
        if (!archivo.exists()) {
            return new DatosGuardados(tickets);
        }
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(archivo))) {
            ...
            String herramientaStr = null;
            String descripcion = null;
            String estado = null;
            String ordenLlegadaStr = null;
            ...
            while ((linea = br.readLine()) != null) {
                ...
                if (linea.startsWith("\"idTicket\"")) {
                    ...
                    resolucion = linea.contains("null")
                            ? null
                            : extraerTexto(linea);

                } else if (linea.startsWith("}") && idTicket != null) {
                    HerramientaSoporte herramienta =
                            HerramientaSoporte.valueOf(herramientaStr);

                    LocalDateTime ordenLlegada =
                            LocalDateTime.parse(ordenLlegadaStr);
            ...
            System.out.println(
                    "Advertencia: no se pudieron cargar los datos ("
                    + e.getMessage() + ")"
            );
